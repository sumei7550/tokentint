...
export default function Page() { return <SeoLandingPage
  ...
  related={[{ href: '/website-color-picker', label: 'Collect colors from a website' }, { href: '/css-variables-generator', label: 'Export CSS custom properties' }, { href: '/design-token-generator', label: 'Export color design tokens' }, { href: '/pricing', label: 'Compare Free and Pro' }]}
  faqs={[{ question: 'How do I export website colors to Tailwind?', answer: 'Collect the colors from the active webpage, organize the useful values in a TokenTint project, and use Pro to export a Tailwind Config starting point.' }, { question: 'Can I create a Tailwind config from an existing website palette?', answer: 'Yes. TokenTint exports the colors you collected as a config-ready color object. You can then refine names, shades, and semantic roles in your codebase.' }, { question: 'Does TokenTint generate 50–950 color shades?', answer: 'No. TokenTint does not promise automatic 50–950 shade generation. The export reflects the colors you collected, and you can define shades and semantic names in your project.' }, { question: 'Is Tailwind Config export free?', answer: 'Tailwind Config export is a Pro feature. Free users can still pick colors, organize one project palette, and export CSS Variables.' }]}
