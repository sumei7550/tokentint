...
export const metadata: Metadata = { title: 'Color Design Token Generator from Website Colors', description: 'Convert colors collected from real interfaces into CSS Variables or W3C Design Tokens with the TokenTint Chrome extension.', alternates: { canonical: '/design-token-generator', languages: { en: '/design-token-generator', 'zh-CN': '/zh-CN/design-token-generator', 'x-default': '/design-token-generator' } } };

export default function Page() { return <SeoLandingPage
  h1="Color Design Token Generator"
  intro="Convert colors collected from real websites and interfaces into reusable CSS or W3C color tokens—without pretending to be a full design-system management platform."
  ...
  related={[{ href: '/website-color-picker', label: 'Collect colors from a website' }, { href: '/css-variables-generator', label: 'Export CSS custom properties' }, { href: '/tailwind-color-generator', label: 'Export a Tailwind-ready palette' }, { href: '/pricing', label: 'Compare Free and Pro' }]}
  faqs={[{ question: 'How do I convert website colors into design tokens?', answer: 'Collect colors from the active website, group the useful values in a TokenTint project palette, and export them as CSS Variables or W3C Design Tokens.' }, { question: 'Does TokenTint export the W3C Design Tokens format?', answer: 'Yes. W3C Design Tokens export is available with Pro. Free users can export project colors as CSS Variables.' }, { question: 'What kind of design tokens does TokenTint generate?', answer: 'TokenTint focuses on color tokens collected from real interfaces. It does not generate typography, spacing, motion, or an entire design system.' }, { question: 'Is this a full design-system management platform?', answer: 'No. TokenTint focuses on collecting, grouping, and exporting colors. Naming conventions, semantic roles, and documentation remain in your existing workflow.' }, { question: 'Can I generate tokens from a live website?', answer: 'Yes. Pick colors from the active webpage, or use Pro page extraction to create a broader starting palette before exporting.' }]}
