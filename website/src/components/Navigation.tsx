      ...
      <div className="container">
        <nav className="nav">
          ...
          <ul className="nav-links nav-actions">
            ...
            <li><a href="https://chromewebstore.google.com/detail/tokentint-%E2%80%93-color-picker/ifcilnndiaddmoppdpnhboaofffnjmbm?utm_source=website" className="nav-cta" data-analytics-location="header">{copy.cta}</a></li>
          </ul>
          <div className="mobile-nav-controls" ref={mobileMenuRef}>
            ...
            {mobileMenuOpen && (
              <>
                ...
                <a href="https://chromewebstore.google.com/detail/tokentint-%E2%80%93-color-picker/ifcilnndiaddmoppdpnhboaofffnjmbm?utm_source=website" className="mobile-nav-cta" data-analytics-location="mobile_header" onClick={() => setMobileMenuOpen(false)}>{copy.cta}</a>
                </div>
              </>
            )}
          </div>
