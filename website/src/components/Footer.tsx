...
export default function Footer() {
  ...
  const copy = locale === 'zh-CN'
    ? {
      ...
      resources: '资源', tools: '所有工具', support: '支持', faq: '常见问题', contact: '联系', legal: '法律', privacy: '隐私', terms: '条款', refunds: '退款', rights: '版权所有。',
    }
    : {
      ...
      resources: 'Resources', tools: 'All Tools', support: 'Support', faq: 'FAQ', contact: 'Contact', legal: 'Legal', privacy: 'Privacy', terms: 'Terms', refunds: 'Refunds', rights: 'All rights reserved.',
    };
      ...
      <div className="container">
        <div className="footer-main">
          ...
          <div className="footer-columns">
            ...
            <div className="footer-column"><h2>{copy.resources}</h2><Link href={path('/tools')}>{copy.tools}</Link><Link href={path('/support')}>{copy.support}</Link><Link href={path('/faq')}>{copy.faq}</Link><a href="mailto:support@tokentint.xyz">{copy.contact}</a></div>
