...
Both assets deliberately reserve clear space at the left for Store-provided title and description. The single source of truth is `../public/icons/icon.svg`; the master at `../assets/tokentint-logo.png` and the required 16, 32, 48, and 128 px PNG exports are derived from the same mark.
